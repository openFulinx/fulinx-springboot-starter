...
import com.fulinx.spring.data.mysql.dao.podo.systemUser.SystemUserPermissionResultDo;
...
public interface IPermissionDao {
    ...
    boolean save(SystemUserPermissionResultDo systemUserPermissionResultDo);
}
